...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index_rs__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index_rs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__index_rs__);


__WEBPACK_IMPORTED_MODULE_0__index_rs___default.a.then(lib => {
...
(function( root, factory ) {
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.lib.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "static/wasm/index.8dec8b92.wasm" );
        ...
        const __promise = fetch(__webpack_require__.p + "static/wasm/index.8dec8b92.wasm")
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'lib'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'lib':", error );
                throw error;
            });
